...
#plot
autoplot(manual_forcast, series = "Forecast") +
  coord_cartesian(xlim = c(38000, 39488))
```
...
Create Results df
```{r}
Model <- c("Naive", "2-Hour MA", "Auto ARIMA", "Manual ARIMA")
Tr_RMSE <- c(Naive_rmse_tr, MA_rmse_tr, auto_arima_rmse_tr, manual_arima_rmse_tr)
Val_RMSE <- c(Naive_rmse_val, MA_rmse_val, auto_arima_rmse_val, manual_arima_rmse_val)
